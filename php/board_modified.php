...
<body id="page-top">
  ...
  <div class="container d-flex h-10 align-items-center" style="padding-top: 100px;">
      <div class="mx-auto text-center">
        <div class="moving-clouds" style="background-image: url('../img/clouds.png'); "></div>
        <h1 class="mx-auto my-0 text-uppercase">Modified</h1><br><br><br><br>
      </div>
    </div>
        ...
        <div class="row" style="color: snow">
            ...
            <p style="font-size:13pt;">[ Title ] : <code style="font-family: 'Nanum Gothic', sans-serif;"><?php echo $board_data['Title'];?></code></p><br>
                ...
                <div class="form-group">
                    <textarea style="font-size:13pt;" class="form-control" rows="15" name = "content" id="content" maxlength="15" type="text" placeholder="Modified Content Input" required autocomplete="off"></textarea>
                </div>
                <div class="form-group">
                    <br>
